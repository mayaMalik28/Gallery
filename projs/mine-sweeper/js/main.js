...
function renderBoard() {
    ...
    for (var i = 0; i < gBoard.length; i++) {
        ...
        for (var j = 0; j < gBoard[0].length; j++) {
            ...
            // var manuelClass = (gGame.manualState.isCurrentlySetting) ? 'show' : '';
            //     strHTML += `\t<td class="cell ${cellClass} ${manuelClass}" onclick="cellClicked(this, ${i}, ${j})" oncontextmenu="markCell(this, ${i}, ${j})">\n`;
            //     strHTML += '\t</td>\n';
            //     continue;
            if (gGame.manualState.isCurrentlySetting) {
